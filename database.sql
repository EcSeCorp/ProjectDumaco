...
IN_ID_CLIENTE INT(8)  NOT NULL AUTO_INCREMENT,
VC_NOMBRE VARCHAR(50),
VC_RUC VARCHAR(11) NOT NULL,
VC_DIRECCION VARCHAR(50),
VC_CIUDAD VARCHAR(30),
VC_PAIS VARCHAR(30),
VC_EMAIL VARCHAR(50) DEFAULT NULL,
CH_ID_USUARIO_CREACION CHAR(8),
DT_FECHA_CREACION DATETIME,
CH_ID_USUARIO_UPDATE CHAR(8),
DT_FECHA_UPDATE DATETIME,

CONSTRAINT  ID_CLIENTE PRIMARY KEY(IN_ID_CLIENTE)
);
...
ALTER TABLE USUARIO ADD CONSTRAINT FK_CLIENTE FOREIGN KEY(IN_ID_CLIENTE)
REFERENCES CLIENTE(IN_ID_CLIENTE);

CREATE TABLE DOCUMENTO(
CH_ID_DOCUMENTO CHAR(8) PRIMARY KEY NOT NULL UNIQUE,
VC_NOMBRE_DOCUMENTO VARCHAR(50),
VC_TIP_TAREA VARCHAR(30)
);
...
CREATE TABLE TAREA (
  ...
  VC_NODO_IIBB_A  varchar(30) DEFAULT NULL,
...
CREATE TABLE PTP(
CH_ID_NODO_S1 CHAR(7),
CH_ID_NODO_S2  CHAR(7),
NU_AZIMUTH_S1 NUMERIC(5,2),
NU_AZIMUTH_S2 NUMERIC(5,2),
NU_ELEVACION_S1 NUMERIC(5,2),
NU_ELEVACION_S2 NUMERIC(5,2),
NU_DISTANCIA_KM NUMERIC(5,2),
NU_COTA_MSNM_S1 NUMERIC(6,2),
NU_COTA_MSNM_S2 NUMERIC(6,2),
VC_ANTENA_MODEL_S1 VARCHAR(30),
VC_ANTENA_MODEL_S2 VARCHAR(30),
VC_DIAMETRO_ANTENA_S1 VARCHAR(30),
VC_DIAMETRO_ANTENA_S2 VARCHAR(30),
IN_ALTURA_ANTENA_S1 INTEGER,
IN_ALTURA_ANTENA_S2 INTEGER,
NU_GANANCIA_ANTENA_S1 NUMERIC(3,1),
NU_GANANCIA_ANTENA_S2 NUMERIC(3,1),
CH_CHANEL_S1 CHAR(8),
CH_CHANEL_S2 CHAR(8),
VC_DISEÑO_FRECUENCIA_S1 VARCHAR(30),
VC_DISEÑO_FRECUENCIA_S2 VARCHAR(30),
VC_POLARIZACION VARCHAR(30),
VC_RADIO_MODEL_S1 VARCHAR(50),
VC_EMISSION_S1 VARCHAR(30),
IN_TX_POWER_S1 INTEGER,
IN_TX_POWER_S2 INTEGER,
NU_EIRP_S1 NUMERIC(3,1),
NU_EIRP_S2 NUMERIC(3,1),
NU_RX_THRESHOLD_S1 NUMERIC(3,1),
NU_RECEIVE_SIGNAL_S1 NUMERIC(4,2),
NU_RECEIVE_SIGNAL_S2 NUMERIC(4,2),
NU_FADE_MARGIN_S1 NUMERIC(4,2),
NU_FADE_MAGIN_S2 NUMERIC(4,2),
NU_ANNUAL_MULTIPATH_AVAILABILITY_S1 NUMERIC(8,5),
NU_ANNUAL_RAIN_AVAILABILITY_S1 NUMERIC(6,3),
NU_ANNUAL_RAIN_AND_MULTIPATH_AVAILABILITY NUMERIC(8,5),
DT_FECHA_CREACION DATETIME,
CH_ID_USUARIO_CREACION CHAR(8)
);

CREATE TABLE IP_PLANNING_PTP(
VC_ID_ESTACION_A VARCHAR(30),
VC_IP_A VARCHAR(30),
VC_ID_ESTACION_B VARCHAR(30),
VC_IP_B VARCHAR(30),
VC_MASCARA_A_B VARCHAR(30),
VC_GATEWAY_A_B VARCHAR(30),
VC_IP_LOCAL VARCHAR(30),
VC_PUERTO_A VARCHAR(30),
VC_PUERTO_B VARCHAR(30),
IN_COLOR_CODE INTEGER,
VC_MAESTRO VARCHAR(30),
VC_SINCRONISMO VARCHAR(30),
DT_FECHA_CREACION DATETIME,
CH_ID_USUARIO_CREACION CHAR(8)
);
...
CREATE PROCEDURE USP_DOCUMENTOS
(IN  NOMBRE_TAREA VARCHAR(200))
BEGIN
	SELECT EDR.CH_ID_VALOR_PRIM
	FROM ENTIDAD_DET_RELACION EDR INNER JOIN ENTIDAD_DETALLE ED 
	ON  EDR.CH_ID_VALOR_SEC=ED.CH_ID_VALOR AND EDR.CH_ID_ENTIDAD_SEC = 'TIP_TAREA'
	WHERE ED.CH_ID_ENTIDAD = 'TIP_TAREA' AND ED.VC_VALOR_CADENA_1 = NOMBRE_TAREA;
END

CREATE PROCEDURE USP_IMAGENES_DOCUMENTO
(IN ID_DOCUMENTO CHAR(8))
BEGIN 
	SELECT  EDR.CH_ID_VALOR_SEC,ED.VC_VALOR_CADENA_1 DESCRIPCION,ED.VC_VALOR_CADENA_2 RUTA
	FROM ENTIDAD_DET_RELACION EDR INNER JOIN ENTIDAD_DETALLE ED 
	ON ED.CH_ID_VALOR = EDR.CH_ID_VALOR_SEC AND (EDR.CH_ID_ENTIDAD_SEC = 'CAMP_EJE' )
	WHERE ED.CH_ID_ENTIDAD = 'CAMP_EJE' AND EDR.CH_ID_VALOR_PRIM = ID_DOCUMENTO;
END